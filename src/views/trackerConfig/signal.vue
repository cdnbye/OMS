  ...
  data() {
    return {
      ...
      list: [
        ...
        { url: 'http://43.131.51.128:7077/count', value: 0, name: 'eu-2' },
        { url: 'http://43.131.28.39:7077/count', value: 0, name: 'eu-3' },
        { url: 'http://43.131.54.71:7077/count', value: 0, name: 'eu-4' },
