  ...
  data() {
    return {
      ...
      list: [
        ...
        { url: 'https://uk.cdnbye.com/count', value: 0, name: '英国' },
        { url: 'https://uk.p2pengine.net:8089/count', value: 0, name: '英国' },
        ...
        { url: 'http://43.153.96.20/count', value: 0, name: 'us-1' },
        ...
        { url: 'http://43.153.96.20:7077/count', value: 0, name: 'us-1' },
