<template>
    <div class="app-container">
        <el-col :xs="10" :sm="4" :lg="2" style="margin: 10px 0">
            <el-button style="float: 'left'" type="primary" @click="dialogFormVisible = true">新增Block IP</el-button>
        </el-col>
        ...
        <el-dialog  :visible.sync="dialogFormVisible" :width="device==='mobile'?'85%':''">
            ...
            <el-form :model="form" label-position="left" label-width="120px" ref="createForm">
                <el-form-item label="IP" label-width="100px" required>
                    <el-input v-model="form.block_ip"></el-input>
                </el-form-item>
            </el-form>
...
<script>
    import { fetchBlockIps, addBlockIp, removeBlockIp } from '@/api/trackerConfig'
    ...
    export default {
        ...
        methods: {
            ...
            fetchData() {
                ...
                fetchBlockIps().then(res => {
                    if(res.data) {
                        if(res.data.block_ips) {
                            this.tableData = res.data.block_ips
                        }
                    }
