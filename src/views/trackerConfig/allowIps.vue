<template>
    <div class="app-container">
        <el-col :xs="10" :sm="4" :lg="2" style="margin: 10px 0">
            <el-button style="float: 'left'" type="primary" @click="dialogFormVisible = true">新增Allow IP</el-button>
        </el-col>
...
<script>
    import { fetchAllowIps, addAllowIp, removeAllowIp } from '@/api/trackerConfig'
    ...
    export default {
        ...
        methods: {
            ...
            fetchData() {
                ...
                fetchAllowIps().then(res => {
                    if(res.data) {
                        if(res.data.allow_ips) {
                            this.tableData = res.data.allow_ips
                        }
                    }
