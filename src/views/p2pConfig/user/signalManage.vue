...
<script>
    ...
    import { p2pConfigSignal } from '@/api/user/p2pConfig'
    ...
    export default {
        ...
        methods: {
            ...
            handleAutoSignal(domain, value) {
                const data = {signal_addr: domain.signal_addr, auto_signal: value}
