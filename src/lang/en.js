export default {
  ...
  navbar: {
    ...
    myInfo: 'Profile',
    currZone: 'Zone: ',
    zoneTip: 'If a non default zone (HK, USA) is selected, you need to manually configure the tracker address for the SDK. Details can be found <a style="color: #337ab7" href="https://swarmcloud.net/tracker.html" target="_blank">here</a>',
  },
  auth: {
    login: 'Login',
    signup: 'Signup',
  ...
  dashboard : {
    ...
    natDis: 'NAT Type',
    domainDis: 'Online',
    p2pTip: 'Want to increase p2p traffic? See <a style="color: #337ab7" href="https://swarmcloud.net/optimization.html" target="_blank">here</a>',
  ...
  seeder: {
    ...
    addr: 'Server Address',
    desc: 'This page is used to configure idle servers as peers (Super Peer) to serve clients that with poor network to original source or cannot connect to other peers. See https://swarmcloud.net/super-peer.html for more details',
    running: 'Running',
    stopped: 'Stopped',
    auto: 'Auto Seeding',
    seed: "Seed",
