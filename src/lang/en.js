export default {
  ...
  myInfo: {
    ...
    vcodeEmailSuccess: 'The verification code has been successfully sent to your mailbox',
    vcodeMobileSuccess: 'The verification code has been successfully sent to your mobile device',
