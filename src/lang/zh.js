export default {
  route: {
    ...
    dataAnalysis: '历史数据',
    p2pTraffic: '流量趋势图',
    p2pTrafficGlobal: '全局流量趋势图',
    onlineNum: '在线人数趋势图',
    onlineNumGlobal: '全局在线人数趋势图',
    domainInfo: '网站管理',
    domainList: '域名列表',
    package: '购买流量包',
  ...
  historyData: {
    ...
    week: '7天',
    month: '30天',
    descGlobal: '此界面用于展示汇总所有域名/APP的历史数据，Web端SDK需要配置 token 才能在此界面统计。',
  },
  package: {
    noBuyTitle: '温馨提示',
