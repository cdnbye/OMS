export default {
  ...
  dashboard: {
    ...
    natDis: 'NAT類型',
    domainDis: '在線人數',
    p2pTip: '如果節省的流量未達到期望，請參考<a style="color: #337ab7" href="https://www.cdnbye.com/cn/optimization.html" target="_blank">文檔</a>進行配置。',
    httpTip: '通過HTTP方式（源服務器或者CDN）下載媒體的流量，HTTP流量和P2P流量加和等於總流量。',
    freeTip: '每日贈送25GB流量，簽到後再額外贈送2GB流量，次日重置。<br/>消耗的P2P流量先用免費流量抵扣，超出部分用付費流量抵扣。<br/>如果可用流量為零，則停止P2P服務。',
  ...
  myInfo: {
    ...
    changeMobile: {
      ...
      number: '請輸入手機號碼',
      cc: '地區碼',
      wrongCCError: '請輸入正確的地區碼',
      wrongError: '請輸入正確的手機號碼',
      sameError: '請不要輸入相同的手機號碼',
    ...
    balanceCNY: '余额(人民币)',
    recharge: '余额充值',
    rechargeTip: '充值金額僅能用於购买流量包和包月套餐，不支持提現。充值金额需为10的整数倍，可参考<a style="color: #337ab7" href="https://www.cdnbye.com/cn/pricing.html" target="_blank">定价</a>。',
    changeMail: {
      change: '修改郵箱',
      newMail: '新郵箱',
      code: '驗證碼',
  ...
  p2pConfig: {
    ...
    uploadRule: {
      ...
      desc: '這裏可以配置在不同網絡環境下的P2P分享策略以及超級節點調度策略，默認情況下允許在蜂窩網絡上傳數據。',
    },
    activationRatio: {
  ...
  app: {
    ...
    appName: 'APP顯示的名稱',
    appID: 'APP ID的獲取方式可參考<a style="color: #337ab7" target="view_window" href="https://www.cdnbye.com/cn/bindings.html#%E7%BB%91%E5%AE%9A-app-id-%E5%B9%B6%E8%8E%B7%E5%8F%96token">這裏</a>',
    platform: '平臺',
    ...
    watch: '監控',
    title: '說明：',
    desc: '本頁面用於配置移動端原生 App 和 Electron，視頻網站請移步"網站管理"頁面綁定域名。每個用戶最多創建100個APP，60天內未使用的App記錄將被自動刪除。創建成功後需要等待1分鐘以上才生效。審核期間可正常使用。',
    appIdTip: 'com.company.example',
    introTip: '輸入你的APP下載鏈接或者APP介紹鏈接',
    signatureTip: '輸入你的APK簽名SHA1值，用於對當前應用進行二次身份校驗(選填, 不建議填寫)，簽名獲取方法可以參考<a style="color: #337ab7" target="view_window" href="https://www.cdnbye.com/cn/troubleshooting.html#%E5%A6%82%E4%BD%95%E8%8E%B7%E5%8F%96%E5%AE%89%E5%8D%93%E5%BA%94%E7%94%A8%E7%AD%BE%E5%90%8D">這裏</a>',
    copied: '已復製',
    illegal: '未通過審核(請聯系客服)',
    signature: '應用簽名(SHA1)',
    updateSign: '更新SHA1',
  ...
  seeder: {
    ...
    seedTitle: '输入做种信息',
    addr: '服务器地址',
    desc: '本页面用于将闲置服务器注册为超级节点，为无法连上其他节点的客户端提供服务。 配置方法请参考https://www.cdnbye.com/cn/super-peer.html',
    running: '运行中',
    stopped: '已停止',
    auto: '自动做种',
    seed: "做种",
    ...
    seedPreferredTip: '是否在刚加入频道时就分配超级节点',
    urgentRatio: '连接超级节点最小阈值',
    urgentRatioTip: '根据P2P效果来分配超级节点，值越大分配的比例越多',
  },
  hotChannels: {
    content: '資源',
    num: '熱度',
    desc: '本頁面用於展示參與P2P加速的資源的熱度，從大到小排序，不展示在線人數太少的資源。',
  },
  invitation: {
    date: '日期',
    copy: '复制邀请链接',
