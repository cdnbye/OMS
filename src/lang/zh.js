export default {
  ...
  dashboard: {
    ...
    netDis: '网络类型分布',
    natDis: 'NAT类型分布',
    p2pTip: '采用北京时间计时。<br/>如果节省的流量未达到期望，请参考<a style="color: #337ab7" href="https://www.cdnbye.com/views/m3u8.html" target="_blank">文档</a>进行配置。',
  ...
  domainTable: {
    ...
    verifySuccess: '验证成功',
    title: '说明：',
    desc: '本页面用于绑定网站域名，移动端原生 App 和 Electron 应用无需绑定域名。每个账号最多可以绑定200个域名。服务于国内的域名必须已备案。',
    illegal: '未通过审核(需要备案)',
  },
  documentation: {
    documentation: '使用文档',
