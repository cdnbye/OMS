export default {
  ...
  navbar: {
    ...
    myInfo: '個人信息',
    currZone: '可用區: ',
    zoneTip: '如果選擇了歐洲以外的可用區，需要手動配置SDK連接的服務器地址，請參考<a style="color: #337ab7" href="https://www.cdnbye.com/views/tracker.html" target="_blank">這裏</a>',
  },
  auth: {
    login: '登入',
    signup: '註冊',
  ...
  myInfo: {
    ...
    balanceCNY: '余额(人民币)',
    recharge: '余额充值',
    rechargeTip: '充值金額僅能用於购买流量包和包月套餐，不支持提現。充值金额可参考<a style="color: #337ab7" href="https://www.cdnbye.com/cn/views/prices.html" target="_blank">定价</a>。',
    changeMail: {
      change: '修改郵箱',
      newMail: '新郵箱',
      code: '驗證碼',
  ...
  seeder: {
    ...
    seedTitle: '输入做种信息',
    addr: '服务器地址',
    desc: '本页面用于将闲置服务器注册为超级节点，为无法连上其他节点的客户端提供服务。 配置方法请参考https://www.cdnbye.com/cn/views/super-peer.html',
    running: '运行中',
    stopped: '已停止',
    auto: '自动做种',
    seed: "做种",
